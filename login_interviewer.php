...
include 'db.php'; // Assuming 'db.php' includes your database connection
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($email) || empty($password)) {
        ...
        $stmt = $conn->prepare("SELECT I_password, status FROM interviewer WHERE I_Email = ?");
        ...
        if ($result->num_rows > 0) {
            ...
            if ($row['status'] == 1) {
                ...
                if (password_verify($password, $row['I_password'])) {
                    ...
                    $_SESSION['role'] = 'Interviewer'; // Store role for future use if needed
...
<body class="page-login">
  ...
  <div class="login-container">
    <div class="card p-4">
      ...
      <form id="loginForm" method="post" action="login_interviewer.php">
